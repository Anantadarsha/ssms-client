...
const Students = () => {
  ...
  useEffect(() => {
    document.title = "Add Students | SMMS | Anantadarsha Sanskrit Ved Vidyalaya";
  }, []);
      ...
      >
        <div className="flex justify-between">
          <div className="px-3 py-3">
            <header className="text-3xl font-bold mb-2">Add Student</header>
            <p className="border-2 border-blue-500 w-20"></p>
          </div>
          <p className="text-gray-500 cursor-pointer hover:underline">
            <Link to="/students/viewAll"> View All Students </Link>
          </p>
        </div>
        <div className="px-3 py-3">
